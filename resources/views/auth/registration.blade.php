...
<div class="flex items-center flex-col">
    ...
    <form action="{{ route('register') }}" method="post" class="w-4/12 mt-5 flex flex-col justify-center items-center pt-4 rouded-md bg-purple-200 border border-gray-400 rounded-md">
        ...
        <input type="text" name="username" id="username" value="{{ old('username') }}" class="w-full bg-gray-100 border border-purple-300 rounded-sm mt-1">
        @error('username')
        ...
        <input type="text" name="email" id="email" value="{{ old('email') }}" class="w-full bg-gray-100 border border-purple-300 rounded-sm mt-1">
        @error('email')
            <div class="text-red-500 mt-3">
                {{ $message }}
            </div>
        ...
        <input type="password" name="password" id="password" class="w-full bg-gray-100 border border-purple-300 rounded-sm mt-1">
        @error('password')
            <div class="text-red-500 mt-3">
                {{ $message }}
            </div>
        ...
        <input type="password" name="password_confirmation" id="password_confirmation" class="w-full bg-gray-100 border border-purple-300 rounded-sm mt-1">
        </div>
